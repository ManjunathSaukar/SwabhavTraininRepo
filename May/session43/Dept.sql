...
SELECT * FROM DEPT 
SELECT * FROM EMP
--ALL EMPLOYEES IN SAME DEPT OF SMITH
SELECT * FROM EMP WHERE DEPTNO IN(
SELECT DEPTNO FROM EMP WHERE ENAME='SMITH')

-- FIND ALL EMPLOYEES WHOOSE DESIGNATION AS SCOTT
SELECT * FROM EMP WHERE JOB IN(
SELECT JOB FROM EMP WHERE ENAME='SCOTT')

--ALL EMLOYEES WHOOSE SALARY IS SAME AS SCOTT
...
--display all dept names and enames if any
SELECT DEPT.DNAME, EMP.ENAME
FROM EMP RIGHT JOIN DEPT
ON EMP.DEPTNO = DEPT.DEPTNO
ORDER BY EMP.ENAME

--display departments where there are no employees
SELECT DEPT.DNAME, EMP.ENAME
FROM EMP RIGHT JOIN DEPT
ON EMP.DEPTNO = DEPT.DEPTNO
...
--display employee name and his manager
select x.ENAME, y.ENAME AS BOSS from 
Emp x left join EMP y
on x.MGR = y.EMPNO

--display all employee names, dept names and manager name
...
SELECT LOCATIONS.STREET_ADDRESS AS LOCATION_NAME, LOCATIONS.CITY, COUNTRIES.COUNTRY_NAME, REGIONS.REGION_NAME
FROM LOCATIONS
