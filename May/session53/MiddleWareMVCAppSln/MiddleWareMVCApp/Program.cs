...
namespace MiddleWareMVCApp
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            //builder.Services.AddSingleton<IEmailService,OutlookService>();
            //builder.Services.AddTransient<IEmailService, OutlookService>();
            builder.Services.AddScoped<IEmailService,OutlookService>();
